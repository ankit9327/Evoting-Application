...
public class DeleteUserControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
     ...
     String data=request.getParameter("data");
        System.out.println("data in deleteusercontrollerserv :"+data);
        try
        {
            if(data!=null &&  data.equalsIgnoreCase("uid"))
            {
                ...
                System.out.println("In if of deleteusercontrollerserv");
            ...
            else
            {
                ...
                System.out.println("In else of deleteusercontrollerserv");
            }
